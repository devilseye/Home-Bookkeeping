...
import devilseye.android.homebookkeeping.adapter.CategoryAdapter;
...
public class CategoryActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add_category) {
            ...
            adb.setTitle(getString(R.string.action_add_category));
            final View dialogView = LayoutInflater.from(this).inflate(R.layout.add_cat_dialog, null);
            adb.setView(dialogView);
            adb.setPositiveButton(getString(R.string.add), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    EditText name = (EditText) dialogView.findViewById(R.id.cat_name);
                    CheckBox income = (CheckBox) dialogView.findViewById(R.id.toLabel);
                    Category category=new Category(income.isChecked(), name.getText().toString());
